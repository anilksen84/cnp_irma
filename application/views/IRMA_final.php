...
$p1=str_replace(',', '',$pae_quantification_1);
$p2 = str_replace(',', '',$po_quantification_1);
$p3 = str_replace(',', '',$oae_quantification_1);
$p4= str_replace(',', '',$ep_quantification_1);
$p5=str_replace(',', '',$ey15_quantification_1);
$p6 = str_replace(',', '',$ey501mil_quantification_1);
$p7=str_replace(',', '',$mae_quantification_1);
$p8=str_replace(',', '',$np_quantification_1);
$p9=str_replace(',', '',$pak_quantification_1);
$p10 = str_replace(',', '',$ame_quantification_1);
$p11 = str_replace(',', '',$ps_quantification_1);
$p12 = str_replace(',', '',$sa_quantification_1);
$p13 = str_replace(',', '',$sap_quantification_1);
$values_grafimatos_with_titles = array(
 array('title'=>$this->lang->line('PROSKERIANIKANOTITAGIAERGASIA'),'value' => $paeres,"price"=>$p1),
 array('title'=>$this->lang->line('PROSTASIAOIKOGENEIAS'),'value' => $pores,"price"=>$p2),
 array('title'=>$this->lang->line('OAE_DESCRIPTION'),'value'=> $oaeres,"price"=>$p3),
 array('title'=>$this->lang->line('EKSONOSOKOMIAKIPERITHALPSI') ,'value'=> $epres,"price"=>$p4),
  array('title'=>$this->lang->line('EKSODAYGEIAS010000'),'value'=> $ey15res,"price"=>$p5),
  array('title'=>$this->lang->line('EKSODAYGEIAS100001000000') ,'value'=> $ey501milres,"price"=>$p6),
 /* "???da ??e?a? 15.000? - 50.000? "=> $ans->ey1550res,*/
  array('title'=>$this->lang->line('MONIMIANIKANOTITAGIAERGASIA'),'value' => $maeres,"price"=>$p7),
  array('title'=>$this->lang->line('NP_DESCRIPTION'),'value'=> $npres,"price"=>$p8),
  array('title'=>$this->lang->line('PROSTASIAKATOIKIAS') ,'value'=> $pakres,"price"=>$p9),
  array('title'=>$this->lang->line('AME_DESCRIPTION'),'value'=> $ameres,"price"=>$p10),
  /*"???stas?a ep??e???s?? "=> $ans->peres,*/
  array('title'=>$this->lang->line('PLANOSINTAKSIODOTISIS'),'value' => $psres,"price"=>$p11),
 array('title'=>$this->lang->line('SOVARESASTHENIES'),'value'  => $sares,"price"=>$p12),
  array('title'=>$this->lang->line('SPOUDESAPOKATASTASI') ,'value'=> $sapres,"price"=>$p13),
);

/*$values_grafimatos_with_titles = array(
 array('title'=>$this->lang->line('PROSKERIANIKANOTITAGIAERGASIA'),'value' => $paeres,"price"=>$pae_quantification_1),
 array('title'=>$this->lang->line('PROSTASIAOIKOGENEIAS'),'value' => $pores,"price"=>$po_quantification_1),
 array('title'=>$this->lang->line('OAE_DESCRIPTION'),'value'=> $oaeres,"price"=>$oae_quantification_1),
 array('title'=>$this->lang->line('EKSONOSOKOMIAKIPERITHALPSI') ,'value'=> $epres,"price"=>$ep_quantification_1),
  array('title'=>$this->lang->line('EKSODAYGEIAS010000'),'value'=> $ey15res,"price"=>$ey15_quantification_1),
  array('title'=>$this->lang->line('EKSODAYGEIAS100001000000') ,'value'=> $ey501milres,"price"=>$ey501mil_quantification_1),
 
  array('title'=>$this->lang->line('MONIMIANIKANOTITAGIAERGASIA'),'value' => $maeres,"price"=>$mae_quantification_1),
  array('title'=>$this->lang->line('NP_DESCRIPTION'),'value'=> $npres,"price"=>$np_quantification_1),
  array('title'=>$this->lang->line('PROSTASIAKATOIKIAS') ,'value'=> $pakres,"price"=>$pak_quantification_1),
  array('title'=>$this->lang->line('AME_DESCRIPTION'),'value'=> $ameres,"price"=>$ame_quantification_1),

  array('title'=>$this->lang->line('PLANOSINTAKSIODOTISIS'),'value' => $psres,"price"=>$ps_quantification_1),
 array('title'=>$this->lang->line('SOVARESASTHENIES'),'value'  => $sares,"price"=>$sa_quantification_1),
  array('title'=>$this->lang->line('SPOUDESAPOKATASTASI') ,'value'=> $sapres,"price"=>$sap_quantification_1),
);*/
$price = array();
...
<table width="100%;" class="bar-table">
    ...
    background-color: grey;"></div> 
                            ...
                            ?>
                             <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td>
                              <td style="color: black;">(<?php if(!empty($values_grafimatos_with_titles[$j]['price'])) { echo number_format((float)str_replace(',', '', $values_grafimatos_with_titles[$j]['price']), 2, '.', ','); } else { echo '0';}?>)</td>
 ...
 <!-- 	<div class="score-head">
    ...
    <?php
      ...
      $lastid = $this->user_model->insertData('irmaresults',$data_or);
  $data = array(
          ...
          <table id="irmatable" style="border-collapse:separate;border-spacing:6px;margin-left: 100px;" border="0" bordercolor="black" class="matrix-box"  width="100%" height="800px" align="center" >
            <tr border="2px">
               <th border="2px" class="shadow" width="20%" height="120px" style="background-color:#0000FF; border-color: #000000; border-size: 2px; border-style: solid;">
                ...
                <?php if (($_SESSION['npkda'] == "5") && ($_SESSION['npke'] == "1")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
             ...
             <th border="2px" class="shadow" width="20%" height="120px" style="background-color:#FFFF00; border-color: #000000; border-size: 2px; border-style: solid;">
                <center>
                  ...
                  <?php if (($_SESSION['npkda'] == "5") && ($_SESSION['npke'] == "2")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <th border="2px" class="shadow" width="20%" height="120px" style="background-color:#FFA500; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "5") && ($_SESSION['npke'] == "3")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                 ...
                 <th border="2px" class="shadow" width="20%" height="120px" style="background-color:#FF0000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "5") && ($_SESSION['npke'] == "4")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <th border="2px" class="shadow" width="20%" height="120px" style="background-color:#FF0000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "5") && ($_SESSION['npke'] == "5")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
              ...
              <tr border="2px">
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#008000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "4") && ($_SESSION['npke'] == "1")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#0000FF; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "4") && ($_SESSION['npke'] == "2")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                 ...
                 <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#FFFF00; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "4") && ($_SESSION['npke'] == "3")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#FFA500; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "4") && ($_SESSION['npke'] == "4")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#FF0000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "4") && ($_SESSION['npke'] == "5")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
              ...
              <tr border="2px">
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#008000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "3") && ($_SESSION['npke'] == "1")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
              ...
              <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#0000FF; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "3") && ($_SESSION['npke'] == "2")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#FFFF00; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "3") && ($_SESSION['npke'] == "3")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px"  style="background-color:#FFA500; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "3") && ($_SESSION['npke'] == "4")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
               ...
               <td border="2px" class="shadow" width="20%" height="120px"  style="background-color:#FFA500; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "3") && ($_SESSION['npke'] == "5")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
              ...
              <tr border="2px">
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#008000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "2") && ($_SESSION['npke'] == "1")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#0000FF; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "2") && ($_SESSION['npke'] == "2")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#0000FF; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "2") && ($_SESSION['npke'] == "3")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
               ...
               <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#FFFF00; border-color: #000000; border-size: 2px; border-style: solid;"> 
                  <center>                       
                   <?php if (($_SESSION['amekda'] == "2") && ($_SESSION['ameke'] == "4")){echo "<h4>AME</h4>";}?>
                    ...
                    <?php if (($_SESSION['npkda'] == "2") && ($_SESSION['npke'] == "4")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                 ...
                 <td border="2px" class="shadow" width="20%" height="120px"  style="background-color:#FFA500; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "2") && ($_SESSION['npke'] == "5")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
              ...
              <tr border="2px">
                 <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#008000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "1") && ($_SESSION['npke'] == "1")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#008000; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "1") && ($_SESSION['npke'] == "2")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#0000FF; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "1") && ($_SESSION['npke'] == "3")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px" style="background-color:#FFFF00; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "1") && ($_SESSION['npke'] == "4")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
                ...
                <td border="2px" class="shadow" width="20%" height="120px"  style="background-color:#FFA500; border-color: #000000; border-size: 2px; border-style: solid;">
                  <center>
                    ...
                    <?php if (($_SESSION['npkda'] == "1") && ($_SESSION['npke'] == "5")){echo "<h4>".$this->lang->line('NP_SHORT')."</h4>";}?>
    ...
    <!-- <div class="col-md-12"> -->
      ...
      <div class="col-md-3" style="margin-left: 125px;">
		...
		<div class="col-md-12" style="margin-top: 55px;">
			<textarea class="form-control rounded-0" rows="3" name="message" value="" id="comment" placeholder="Ειδικες Παρατηρήσεις"></textarea>
		</div>
		<div class="col-md-8">
 			<div class="btn-bg3">

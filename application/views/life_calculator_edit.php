...
<form method="POST" class="form-horizontal form-condensed" action='<?php echo base_url();?>report-edit/<?php echo $id; ?>'>
	...
	<div id="obligationToThirdParty" class="tabcontent tab-con1">
      ...
      <input type="text" class="form-control input2" name="sumofgeneraldebt" id="sumofgeneraldebt" class="form-control" placeholder="<?php echo $this->lang->line('EPEKSIGISI_KATANALOTIKA'); ?>" value="<?php echo $report->sumofgeneraldebt;?>">
      <input type="hidden" class="form-control input2" name="cal_id" value="<?php echo $report->id;?>"> 
      <input type="hidden" class="form-control input2" name="clientid" value="<?php echo $report->id_pelati;?>"> 
    </div>
    <div class="form-group col-sm-6"> 
      ...
      <select id="inputState1" class="form-control  input2" name="housingbankinsurance">
        ...
        <option value="<?php echo $this->lang->line('OXI'); ?>" <?php if($report->housingbankinsurance == $this->lang->line('OXI')){ echo 'selected'; } ?>><?php echo $this->lang->line('OXI'); ?></option>
        <option value="<?php echo $this->lang->line('NAI'); ?>" <?php if($report->housingbankinsurance == $this->lang->line('NAI')){ echo 'selected'; } ?>><?php echo $this->lang->line('NAI'); ?></option>
      </select>
    </div>
    <div class="form-group col-sm-6">
      <label for="mortgages" class="label1"><?php echo $this->lang->line('STEGASTIKADANEIA'); ?></label>
      <input type="text" class="form-control input2" name="remaininghousingdebt"  placeholder="<?php echo $this->lang->line('EPEKSIGISI_EKRREMES_STEGASTIKO'); ?>" value="<?php echo $report->remaininghousingdebt;?>">
    </div>
    <div class="form-group col-sm-6"> 
      <label for="areTheseLoansInsured?" class="label1"><?php echo $this->lang->line('ASFALISMENA'); ?></label>
      <select id="inputState2" class="form-control  input2" name="payondeath">
        <option value=""><?php echo $this->lang->line('SELECT_TEXT'); ?></option>
        <option value="<?php echo $this->lang->line('OXI'); ?>" <?php if($report->payondeath == $this->lang->line('OXI')){ echo 'selected'; } ?>><?php echo $this->lang->line('OXI'); ?></option>
        <option value="<?php echo $this->lang->line('NAI'); ?>" <?php if($report->payondeath == $this->lang->line('NAI')){ echo 'selected'; } ?>><?php echo $this->lang->line('NAI'); ?></option>
      </select>
    </div>
    <div class="form-group col-sm-6">
      ...
      <input type="text" class="form-control input2" name="forosklironomias" id="forosklironomias"  value="<?php echo $report->forosklironomias;?>">
    </div>
  </div>
	...
	<a href="javascript:void(0);" onclick="opentab1(event, 'family')" class="btn btn-10"><?php echo $this->lang->line('EPOMENO'); ?><i class="fas fa-caret-right padng5"></i></a>
      ...
      <input type="text" class="form-control input2 marg-top50" name="dilothen" id="dilothen" value="<?php echo $report->dilothen;?>">
    </div>
    <div class="form-group col-sm-6"> 
   ...
   <input type="text" class="form-control input2" name="minimumfamilysurvivalamount" id="minimumfamilysurvivalamount" value="<?php echo $report->minimumfamilysurvivalamount;?>" onclick="myFunction()">
   <p id="noticeminimum" style="color: red; weight: 600;display:none">Το ελάχιστο εισόδημα επιβίωσης πρέπει να είναι μικρότερο η ίσο του δηλωθέν.</p>
    ...
    <div class="form-group col-sm-6">
      ...
      <input type="text" class="form-control input2 marg-top36" name="idealfamilyincome" id="idealfamilyincome" value="<?php echo $report->idealfamilyincome;?>" onclick="myFunction1()">
    ...
    <div class="form-group col-sm-6"> 
      ...
      <input type="text" class="form-control input2" name="familysurvivalyears" value="<?php echo $report->familysurvivalyears;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="numberofyears" class="label1"><?php echo $this->lang->line('EPITHIMITOSXRONOSMOANEW'); ?></label>
      <input type="text" class="form-control input2" name="moayears" value="<?php echo $report->moayears;?>">
    </div>
  </div>
	...
	<a href="javascript:void(0);" onclick="opentab1(event, 'permanentTotalDisability')" class="btn btn-10"><?php echo $this->lang->line('EPOMENO'); ?><i class="fas fa-caret-right padng5"></i></a>
      ...
      <input type="text" class="form-control input2" name="houseandequipmentcost" value="<?php echo $report->houseandequipmentcost;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="monthlyconsumables" class="label1"><?php echo $this->lang->line('MHNIAIAANALOSIMA'); ?></label>
      <input type="text" class="form-control input2" name="montlhycare"  value="<?php echo $report->montlhycare;?>">
    </div>
    </div>
	...
	<a href="javascript:void(0);" onclick="opentab1(event, 'studies')"  class="btn btn-10"><?php echo $this->lang->line('EPOMENO'); ?><i class="fas fa-caret-right padng5"></i></a>
      ...
      <input type="text" class="form-control input2" name="numberofchildrenuni" value="<?php echo $report->numberofchildrenuni;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="studiesattheStateUniversity" class="label1"><?php echo $this->lang->line('DIMOSIOUNISAME'); ?></label>
      <input type="text" class="form-control input2" name="dimosiosamecity"value="<?php echo $report->dimosiosamecity;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="studiesattheStateUniversityinanothercity" class="label1"><?php echo $this->lang->line('DIMOSIOUNIOTHER'); ?></label>
      <input type="text" class="form-control input2" name="dimosioothercity" value="<?php echo $report->dimosioothercity;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="studiesataprivateuniversity" class="label1"><?php echo $this->lang->line('PRVUNI'); ?></label>
      <input type="text" class="form-control input2" name="privategreece"  value="<?php echo $report->privategreece;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="studiesAbroad" class="label1"><?php echo $this->lang->line('ABROADUNI'); ?></label>
      <input type="text" class="form-control input2" name="studyabroad" value="<?php echo $report->studyabroad;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="masterorDoctorateDegree" class="label1"><?php echo $this->lang->line('POSTUNI'); ?></label>
      <input type="text" class="form-control input2" value="<?php echo $report->postgraduate;?>" name="postgraduate">
    </div>
    </div>
	...
	<a href="javascript:void(0);" onclick="opentab1(event, 'income')"  class="btn btn-10"><?php echo $this->lang->line('EPOMENO'); ?><i class="fas fa-caret-right padng5"></i></a>
      ...
      <input type="text" class="form-control input2" name="monthlypensionwidow" value="<?php echo $report->monthlypensionwidow;?>" >
    </div>
    <div class="form-group col-sm-6">
      <label for="yearsofPension" class="label1"><?php echo $this->lang->line('ETHPAROXISKOINWNIKOTAMEIO'); ?></label>
      <input type="text" class="form-control input2" name="monthlypensionwidowyears" value="<?php echo $report->monthlypensionwidowyears;?>" >
    </div>
    <div class="form-group col-sm-6">
      <label for="monthlyPensionDueTODisability" class="label1"><?php echo $this->lang->line('MHNIAIASINTAKSIANAPIRIA'); ?></label>
      <input type="text" class="form-control input2" name="monthlypensionhc" value="<?php echo $report->monthlypensionhc;?>" >
    </div>
    <div class="form-group col-sm-6">
      <label for="yearsofPensionBenefits" class="label1"><?php echo $this->lang->line('ETHPAROXISKOINWNIKOTAMEIO'); ?></label>
      <input type="text" class="form-control input2" name="monthlypensionhcyears" value="<?php echo $report->monthlypensionhcyears;?>" >
    </div>
    <!-- <div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
      ...
      <input type="text" class="form-control input2" name="privatesavings" id="privatesavings" value="<?php echo $report->privatesavings;?>" >
    </div>
    <div class="form-group col-sm-4">
      <label for="indemnityFromOtherExistingDisability" class="label1"><?php echo $this->lang->line('OTHERKEFALEOMOA'); ?></label>
      <input type="text" class="form-control input2"  name="othermoainsurance" id="othermoainsurance" value="<?php echo $report->othermoainsurance;?>" >
    </div>
    <div class="form-group col-sm-2">
      <label for="indemnityFromOtherExistingDisability" class="label1"><?php echo $this->lang->line('life_cal_saveing'); ?></label>
      <input type="text" class="form-control input2"  name="life_saving" id="life_saving" placeholder="0" value="<?php echo $report->life_saving;?>">
    </div>
    <div class="form-group col-sm-6">
      <label for="incomeRelativesCanProvide" class="label1"><?php echo $this->lang->line('INCOMERELATIVES'); ?></label>
      <input type="text" class="form-control input2" name="offeredincome" value="<?php echo $report->offeredincome;?>" >
    </div>
    <div class="form-group col-sm-6">
      <label for="yearsWhereRelativesCanProvideIncome" class="label1"><?php echo $this->lang->line('INCOMERELATIVESYEARS'); ?></label>
      <input type="text" class="form-control input2" name="offeredincomeyears" value="<?php echo $report->offeredincomeyears;?>" >
    </div>
	</div>
    ...
    <input type="submit" class="btn btn-10 btn-clr" value="<?php echo $this->lang->line('EDIT_BUTTON'); ?>">

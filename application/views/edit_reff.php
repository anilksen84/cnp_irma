...
<?php } ?>
   ...
   <div class="form-row marg20">
    ...
    <div class="form-group col-sm-6">
      ...
      <input type="radio" class="" id="Yes" name="call_status" value="Yes" <?php if($customer->call_status == 'Yes'){ echo 'checked="checked"';}?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('NAI');?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <input type="radio" class="" id="Yes" name="call_status" value="No" <?php if($customer->call_status == 'No'){ echo 'checked="checked"';}?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('OXI');?> 

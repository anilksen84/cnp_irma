...
<?php } ?>
  ...
  <!--  <a href="#" class="back-page" onclick="goBack()"><i class="fas fa-backward bck-icon"></i><?php echo $this->lang->line('BACKDASH');?></a> -->
   ...
   <?php 
    ...
    $ey501milke = isset($_SESSION['ey501milke'])?$_SESSION['ey501milke']:'';

    $ey501milkda = isset($_SESSION['ey501milkda'])?$_SESSION['ey501milkda']:'';

    $ey501mil_social_benefit = isset($_SESSION['ey501mil_social_benefit'])?$_SESSION['ey501mil_social_benefit']:'';

    $ey501mil_quantification_1 = isset($_SESSION['ey501mil_quantification_1'])?$_SESSION['ey501mil_quantification_1']:'';

    $ey501mil_quantification_2 = isset($_SESSION['ey501mil_quantification_2'])?$_SESSION['ey501mil_quantification_2']:'';

    $ey501mil_existing_policy = isset($_SESSION['ey501mil_existing_policy'])?$_SESSION['ey501mil_existing_policy']:'';
...
<?php } ?>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control input2" id="ey501mil_quantification_1" name="ey501mil_quantification_1" value="<?php echo $ey501mil_quantification_1;?>">
      ...
      <select id="inputState7" class="form-control  input2" name="ey501mil-ke">
      ...
      <select id="inputState8" class="form-control  input2"  name="ey501mil-kda">
      ...
      <input type="text" class="form-control input2" id="ey501mil_social_benefit" name="ey501mil_social_benefit" value="">
      ...
      <select id="inputState9" class="form-control  input2" name="ey501mil_existing_policy" id="ey501mil_existing_policy">

        <option value="">Select</option>

       <option value="1" <?php if($ey501mil_existing_policy == '1'){ echo 'selected';}?>>Yes</option>

        <option value="0" <?php if($ey501mil_existing_policy == '0'){ echo 'selected';}?>>No</option>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control input2" id="ey501mil_quantification_2" name="ey501mil_quantification_2" value="<?php echo $ey501mil_quantification_2;?>">

  ...
  <div class="clearfix"></div>  
    ...
    <div class="container top-mrgn">
    	...
    	<div class="login-back" >
    		...
    		<img src="<?php echo base_url();?>assets/images/CNPlogo.png">
         ...
         <?php 
    		 ...
    		 <form class="form1" method="post" action="<?php echo base_url(); ?>index.php/loginMe">
   ...
   <div class="footer login-ftr">
   	...
   	<div class="row">
   		...
   		<div class="col-sm-6">
   			...
   			<p class="copy-text" style="color: #fff !important">Copyright 2018, IFA Academy</p>

   		</div>

   		<div class="col-sm-6">
<!-- 
   			<p class="develop-text" style="color: #fff !important">Developed By: Codersspace</p> -->
        <p class="develop-text">Developed By: <a href="http://codersspace.com" style="color: #fff;">Codersspace</a></p>

...
<div class="clearfix"></div><br/>
 ...
 <div class="alert alert-warning" style="margin-bottom: 10rem;">
  ...
  <strong><?php echo "Οι αλλαγές στο προφίλ του χρήστη $profile->onoma $profile->epomino έγιναν με επιτυχία. <span class='push-right'><a href='Client-Profile' />Επιστροφή στη Σύνοψη.</a></span>";?>

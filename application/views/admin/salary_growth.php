...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css">
   ...
   <div class="form-page">
   	<h3 class="head2"><?php //echo $this->lang->line('ADMINH1');?> <?php //echo $this->lang->line('ADMINH2');?> Salary Growth Rate</h3>
   </div>
...
<?php
  ...
  <thead class="cf">
    <tr>
      <th class="th-sm"><?php //echo $this->lang->line('ΑDMINH5');?> S.No.
        <i class="float-right" aria-hidden="true"></i>
      </th>
      <th class="th-sm"><?php //echo $this->lang->line('Name');?> Year
        <i class="float-right" aria-hidden="true"></i>
      </th>
      <th class="th-sm"><?php //echo $this->lang->line('Surname');?>Rate
        <i class="float-right" aria-hidden="true"></i>
      </th>
  ...
  foreach($customer as $cus) { ?>
    <tr>
      ...
      <td data-title="Name"><?php echo $cus->years;?></td>
      <td data-title="Surname"><?php echo $cus->rate;?></td>
 
      <td data-title="Edit"><a href="<?php echo base_url();?>Admin/Edit-growth-rate/<?php echo $cus->id;?>"><img src="<?php echo base_url();?>assets/images/edit.png"></a></td>
...
<!--     <tr>
 ...
 <div class="container">
 	...
 	<a href="<?php echo base_url();?>Admin/Add-growth-rate" class="btn btn-10 btn-clr marg-lft25"><?php //echo $this->lang->line('ΑDMINH7');?> Add New</a>
 </div>
  <!--table-ends-->
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form method="post" action="<?php echo base_url();?>adashboard/delete_growth">

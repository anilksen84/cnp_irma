...
<!--    <a href="#" class="back-page" onclick="goBack()"><i class="fas fa-backward bck-icon"></i>Back</a> -->
   ...
   <div class="form-page">
    ...
    <h3 class="head2"><?php echo $this->lang->line('iplist');?> </h3>
...
<?php
  ...
  <thead class="cf">
    ...
    <tr>
      ...
      <th class="th-sm"><?php echo $this->lang->line('ipadd');?>
      ...
      <th class="th-sm"><?php echo $this->lang->line('POLI');?>
       ...
       <th class="th-sm"><?php echo $this->lang->line('XWRA');?>

        <i class="float-right" aria-hidden="true"></i>

      </th> 

      <th class="th-sm"><?php echo $this->lang->line('IMEROMINIA');?>
  ...
  foreach($ip_details as $cus) { 
$query = @unserialize(file_get_contents('http://ip-api.com/php/'.$cus->ip_add));
    ...
    <tr>
      ...
      <td data-title="ID"><?php echo $customer->id;?></td>

      <td data-title="Name"><?php echo $customer->onoma;?></td>

      <td data-title="Surname"><?php echo $customer->epomino;?></td>

      <td data-title="Email"><?php echo $cus->ip_add;?></td>

      <td data-title="City"><?php echo $query['city'];?></td>

      <td data-title="IRMA Reports Archive"><?php echo $query['country'];?></td>

       <td data-title="IRMA Reports Archive"><?php echo $cus->login_date;?></td>
...
<!--     <tr>
 ...
 <div class="container">
 	...
 	<?php if($customer->blocked == '10'){ ?>

  <a href="<?php echo base_url();?>Admin/unblock_user/<?php echo $customer->id;?>" class="btn btn-10 btn-clr marg-lft25"><?php echo $this->lang->line('unblockuser');?></a>

  <?php }else{ ?>

 	<a href="<?php echo base_url();?>Admin/block_user/<?php echo $customer->id;?>" class="btn btn-10 btn-clr marg-lft25"><?php echo $this->lang->line('blockuser');?></a>

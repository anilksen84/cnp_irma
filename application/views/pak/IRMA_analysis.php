...
$pakke = isset($_SESSION['pakke'])?$_SESSION['pakke']:'';

$pakkda = isset($_SESSION['pakkda'])?$_SESSION['pakkda']:'';

$pak_social_benefit = isset($_SESSION['pak_social_benefit'])?$_SESSION['pak_social_benefit']:'';

$pak_quantification_1 = isset($_SESSION['pak_quantification_1'])?$_SESSION['pak_quantification_1']:'';

$pak_quantification_2 = isset($_SESSION['pak_quantification_2'])?$_SESSION['pak_quantification_2']:'';

$pak_existing_policy = isset($_SESSION['pak_existing_policy'])?$_SESSION['pak_existing_policy']:'';
...
<?php if($ifan->ifan_status != 1) { ?>
   <object wmode="transparent" width="100%" height="300px" data="<?php echo base_url();?>gfx/ifan_pyros.swf"></object>
<?php } else {?>
...
<?php } ?>
   <!-- <a href="pdf" class="btn btn-11">Ο IFAN ενημερώνει για τις καλύψεις του ταμειου<i class="fas fa-info-circle"></i></a> -->
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control input2" id="pak_quantification_1" name="pak_quantification_1" value="<?php echo $pak_quantification_1;?>">
      ...
      <select id="inputState9" class="form-control  input2" name="pak_existing_policy" id="pak_existing_policy">
        ...
        <option value="">Select</option>
         ...
         <option value="1" <?php if($pak_existing_policy == '1'){ echo 'selected';}?>>Yes</option>

        <option value="0" <?php if($pak_existing_policy == '0'){ echo 'selected';}?>>No</option>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control input2" id="pak_quantification_2" name="pak_quantification_2" value="<?php echo $pak_quantification_2;?>">      

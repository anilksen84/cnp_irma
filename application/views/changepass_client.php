...
<div class="clearfix"></div>
  ...
  <div class="mrgn60">
      ...
      ?>
        <div class="alert alert-danger" id="pass_error" style="display: none;"></div>
...
function goBack() {
 ...
 $.validator.setDefaults({
    ...
    $().ready(function() {
        ...
        $("#profile").validate({
            ...
            messages: {
                password: "<?php echo $this->lang->line('reqired'); ?>",
               
                confirmpwd: "*<?php echo $this->lang->line('reqired'); ?>",
 ...
 // alert(password);  alert(conf);
    ...
    if (password.length < 6) {
      ...
      $("#pass_error").html('Passwords must be at least 6 characters long.  Please try again');
    ...
    if (!re.test(password)) {
      $("#pass_error").css('display','');
      $("#pass_error").html('Passwords must contain at least one number, one lowercase and one uppercase letter.  Please try again');
    ...
    if (password != conf) {
       $("#pass_error").css('display','');
      $("#pass_error").html('Your password and confirmation do not match. Please try again');

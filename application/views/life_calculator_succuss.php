...
<div class="clearfix"></div>
  ...
  <div class="container">
 	...
 	<h1><?php echo $this->lang->line('thankyou');?></h1><br/><br/>
...
<div class="row">
 ...
 <div class="col-md-3">
        ...
        <a href="<?php echo base_url();?>" class="btn btn-3"><?php echo $this->lang->line('go_to_dash');?></a>

      </div>

      <div class="col-md-3">

        <a href="<?php echo base_url();?>clientDetails/<?php echo $last;?>" class="btn btn-4"><?php echo $this->lang->line('go_to_profi');?></a>

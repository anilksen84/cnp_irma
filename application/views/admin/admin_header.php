  ...
  <div class="collapse navbar-collapse nav-right" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
          ...
          <a class="nav-link" href="<?php echo base_url();?>Admin-Dashboard"><span>|</span><i class="fas fa-home"></i><?php echo $this->lang->line('DASHBOARD'); ?></a>

      </li>

      <li class="nav-item">

        <a class="nav-link" href="<?php echo base_url();?>admin/logout"><span>|</span><i class="fas fa-sign-out-alt"></i>Logout</a>

...
<!--   <div class="container">
 ...
 <?php } ?>
  ...
  <thead class="cf">
    <tr>
      <th class="th-sm" style="width: 20%"><?php echo $this->lang->line('ONOMA'); ?>
        
      </th>
      <th class="th-sm" style="width: 23%"><?php echo $this->lang->line('EPONIMO'); ?>
       
      </th>
      <th class="th-sm" style="width: 80px;"><?php echo $this->lang->line('EMAIL'); ?>
       
      </th>
      <th class="th-sm"><?php echo $this->lang->line('Telephone'); ?>
      ...
      <!-- <th class="th-sm"><?php echo $this->lang->line('From'); ?>
       ...
       <th class="th-sm"><?php echo $this->lang->line('ref_call'); ?>
        
      </th>
      <th class="th-sm" style="width: 43%;"> <?php echo $this->lang->line('ref_refby');?>
...
$cus_details = $this->user_model->getClientName($com->id_pelati);
        ?>
    <tr>
      <td data-title="Name" style="font-size: 13px;"><?php echo ucwords(strtolower($com->name));?></td>
      <td data-title="Surname" style="font-size: 13px;"><?php echo ucwords(strtolower($com->lastname));?></td>
      <td data-title="Surname" style="font-size: 13px;"><?php echo $com->email;?></td>
      <td data-title="Telephone" style="font-size: 13px;"><?php echo $com->telephone;?></td>
      <td data-title="Created" style="font-size: 13px;"><?php echo $com->creation_date;?></td>
     <!--  <td data-title="From">Παναγιωτης Λελεδακης</td> -->
      <td data-title="Created" style="font-size: 13px;"><?php echo $com->call_status;?></td>
      <td style="font-size: 13px;"> <a href="<?php echo base_url();?>clientDetails/<?php echo $com->id_pelati;?>" style="color: #0b2b50;"><?php echo  ucwords(strtolower($cus_details->customername)).' '. ucwords(strtolower($cus_details->customerlastname));?></a> </td>
      <td data-title="Comments" style="font-size: 13px;"><a href="#" data-toggle="tooltip" data-placement="top" title="<?php echo $com->comments;?>" style="text-decoration: none;color: black;"><?php if(strlen($com->comments) > 50 ){ echo substr($com->comments,0,50).'....' ;}else{ echo $com->comments;}?></a><!-- <a href="" data-toggle="modal" data-target="#exampleModal" class="a1">read more</a> --></td>

...
<table width="100%;" class="bar-table">
                   ...
                   $key1 = $key.' ('.$value.')';
                    ?>
                     <tr>
                            ...
                            ?>
                            <td colspan="<?php echo $value*5;?>" style="padding-right:0px;">
    ...
    <?php echo $userColorFinal;?>">
                            ...
                            {
                              ?>
                              <td width="0.5%" colspan="<?php echo 125-($value*5);?>" style="padding-right:0px;">
    ...
    <?php
      ...
      $lastid = $this->user_model->insertData('irmaresults',$data);
       ...
       $data = array(
        ...
        'sa_existing_policy'=>$ps_existing_policy,
      ...
      <div class="col-md-3" style="margin-left: 125px;">
       ...
       <!--  <span><?php echo $this->lang->line('NP_SHORT');?> | <?php echo $this->lang->line('NP_DESCRIPTION');?> </span><br/>
        ...
        <span><?php echo $this->lang->line('ΟΑΕ_SHORT');?> | <?php echo $this->lang->line('OAE_DESCRIPTION');?></span><br/> -->
         <span><?php echo $this->lang->line('PSSHORT');?> | <?php echo $this->lang->line('PROSTASIAKATOIKIAS');?></span><br/>

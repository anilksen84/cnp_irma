...
$annual_sal1 = (isset($customer->annual_sal1) && !empty($customer->annual_sal1)) ? $customer->annual_sal1 : '';

$annual_sal2 = (isset($customer->annual_sal2) && !empty($customer->annual_sal2)) ? $customer->annual_sal2 : '';
 ...
 <!--  <link href="<?php echo base_url();?>assets/css/demo.css" rel="stylesheet" /> -->
  ...
  <div class="form-row">
    ...
    <div class="form-group col-sm-6">
      ...
      <input type="text" class="form-control input2 datepicker"  name="customerdob" value="<?php echo $customerdob ;?>">
    ...
    <div class="form-group col-sm-6">
     ...
     <div class="form-group col-sm-6">
      ...
      <input type="text" class="form-control input2" name="annual_sal1" id="annual_sal1" value="<?php echo $annual_sal1;?>">
     ...
     <div class="form-group col-sm-6">
      ...
      <input type="text" class="form-control input2" name="annual_sal2" id="annual_sal2" value="<?php echo $annual_sal2;?>">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-sm-6">
      ...
      <select id="publicinsurance" name="publicinsurance" class="form-control  input2">
        ...
        <option value="yes" <?php if('yes' == $publicinsurance){ echo 'selected';}?>>Yes</option>

        <option value="no" <?php if('no' == $publicinsurance){ echo 'selected';}?>>No</option>

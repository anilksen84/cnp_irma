...
<?php } ?>
   ...
   <div class="form-row marg20">
    ...
    <div class="form-group col-sm-6">
      ...
      <select class="form-control" name="area">
        ...
        <option value="Vijay nagar">Vijay nagar</option>
         <option value="Khajranana">Khajranana</option>
      </select>
    </div>
    ...
    <div class="form-group col-sm-6">
      ...
      <input type="radio" class="form-control" id="Yes" name="call_status" value="Yes"><?php echo $this->lang->line('NAI');?>
       <input type="radio" class="form-control" id="Yes" name="call_status" value="No" checked="checked"><?php echo $this->lang->line('OXI');?> 
...
<div class="form-group col-sm-6">
     ...
     <textarea class="form-control rounded-0" name="cutomernotes" id="cutomernotes"  rows="1" id="refsxolia" name="refsxolia"></textarea>
   ...
   <button type="submit" class="btn btn-10 btn-clr"><?php echo $this->lang->line('PROSTHIKI');?></a></button>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<!-- <a href="<?php echo base_url();?>Add-Appointment-analysis/<?php echo $customer->id;?>" class="btn btn-10 marg-lft15"><?php echo $this->lang->line('ANALISIKAISINEXIA');?><i class="fas fa-caret-right"></i></a> -->
<a href="<?php echo base_url();?>calculation-analysis/<?php echo $customer->id;?>" class="btn btn-10"><?php echo $this->lang->line('ANALISIKAISINEXIA');?><i class="fas fa-caret-right"></i></a>

  ...
  <div id="client" class="tabcontent tab-con1" style="display: block;">
      ...
      <div id="container" style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto"></div>
        ...
        <div class="col-md-6">
          ...
          <div class="sec-1">
            <span class="left-side"><?php echo $this->lang->line('widow');?></span>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#widow1" class="right-side"><?php echo count($ok_f_no); ?></a>
          </div>
          <div class="sec-1">
            <span class="left-side"><?php echo $this->lang->line('widow_with');?></span>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#widow_with1" class="right-side"><?php echo count($ok_g_no); ?></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="activity" class="tabcontent tab-con1">
    ...
    <div class="row">
      ...
      <div id="container_report" style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto"></div>
        ...
        <div class="col-md-6">
          <span class="marital-head"><?php echo $this->lang->line('who_has');?></span>
         <!--  <span class="marital-head" style="float: right; width: 47%"><?php //echo $this->lang->line('investment');?>Who do not have</span> -->
          ...
          <div class="sec-1">
            <span class="left-side"><?php echo $this->lang->line('dash_home_ins');?> <?php //echo $this->lang->line('insurance');?></span>
          ...
          <div class="sec-1">
            <span class="left-side"><?php echo $this->lang->line('vehicle');?></span>
          ...
          <div class="sec-1">
            <span class="left-side"><?php echo $this->lang->line('dash_veh_ins');?> <?php //echo $this->lang->line('insurance');?></span>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#dd65" class="right-side active" ><?php echo count($car_ins_d);?></a>
          ...
          <div class="sec-1">
            <span class="left-side"><?php echo $this->lang->line('dash_bus_ins');?> <?php //echo $this->lang->line('insurance');?></span>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#dd67" class="right-side active" ><?php echo count($bus_ins_d);?></a>
...
<!-- &nbsp;&nbsp;&nbsp; <span class="left-side" style="width: 37%"><?php echo $this->lang->line('boat');?></span>
           ...
           <div class="sec-1">
            <span class="left-side"><?php echo $this->lang->line('dash_boat_ins');?>  <?php //echo $this->lang->line('insurance');?></span>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#dd69" class="right-side active" ><?php echo count($boat_ins_d);?></a>
  ...
  foreach($ok_e_no as $cus) { ?>
   ...
   <!-- Modal ends-->
   <!-- Modal -->
  <div class="modal fade" id="widow1" tabindex="-1" role="dialog" aria-labelledby="widow1" aria-hidden="true">
    <div class="modal-dialog modal1" role="document">
    <div class="modal-content">
      <div class="modal-header modal-head1">
      <h5 class="modal-title" id="divorced1"><?php echo $this->lang->line('widow');?></h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
  ...
  <tbody>
     <?php if(!empty($ok_f_no)){ 
  //  print_r($customer);
  foreach($ok_f_no as $cus) { ?>
    <tr>
      <td data-title="ID"><?php echo $cus->arithmostautotitas;?></td>
      <td data-title="Name"><a href="<?php echo base_url();?>clientDetails/<?php echo $cus->id?>" style="color: #0b2b50;"><?php echo $cus->customername;?></a></td>
      <td data-title="Surname"><a href="<?php echo base_url();?>clientDetails/<?php echo $cus->id?>" style="color: #0b2b50;"><?php echo $cus->customerlastname;?></td></td>
   ...
   <!-- Modal ends-->
    <!-- Modal -->
  <div class="modal fade" id="widow_with1" tabindex="-1" role="dialog" aria-labelledby="widow_with1" aria-hidden="true">
    <div class="modal-dialog modal1" role="document">
    <div class="modal-content">
      <div class="modal-header modal-head1">
      <h5 class="modal-title" id="divorced1"><?php echo $this->lang->line('widow_with');?></h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
  ...
  <tbody>
     <?php if(!empty($ok_g_no)){ 
  //  print_r($customer);
  foreach($ok_g_no as $cus) { ?>
    <tr>
      <td data-title="ID"><?php echo $cus->arithmostautotitas;?></td>
      <td data-title="Name"><a href="<?php echo base_url();?>clientDetails/<?php echo $cus->id?>" style="color: #0b2b50;"><?php echo $cus->customername;?></a></td>
      <td data-title="Surname"><a href="<?php echo base_url();?>clientDetails/<?php echo $cus->id?>" style="color: #0b2b50;"><?php echo $cus->customerlastname;?></td></td>
...
$cus = $this->user_model->get_cus_name($invesment->cus_id);
    ...
    <tr>
      ...
      <td data-title="Surname"><a href="mailto:<?php echo $cus->customeremail;?>"><?php echo $cus->customeremail;?></a></td>
  ...
  <div class="modal fade" id="dd62" tabindex="-1" role="dialog" aria-labelledby="dd62" aria-hidden="true" >
    <div class="modal-dialog modal1 modal-lg" role="document">
  ...
  <div id="no-more-tables" class="table1">
  <table id="example9" class="table table-striped table-bordered" cellspacing="0">
  <thead class="cf">
    <tr>
      <th class="th-sm"><?php echo $this->lang->line('PINAKAS_AT');?></th>
      <th class="th-sm"><?php echo $this->lang->line('ONOMA');?></th>
  ...
  foreach($home as $home) { 
            $h1val = json_decode($home->home);
            $totalVal = count($h1val);
            $homeIns = json_decode($home->home_ins);
            $homeInsCount = count($homeIns);
          
            if($totalVal > 0) {
$cus = $this->user_model->get_cus_name($home->cus_id);
for($m=0;$m<$totalVal;$m++) {
    ?>
    <tr>
      <td data-title="ID"><?php echo $k;?></td>
      ...
      <td data-title="Surname"><a href="<?php echo base_url();?>clientDetails/<?php echo $home->cus_id?>" style="color: #0b2b50;"><?php echo $cus->customerlastname;?></td>
      <td data-title="Surname"><a href="mailto:<?php echo $cus->customeremail;?>"><?php echo $cus->customeremail;?></a></td>
      <td data-title="City"><?php        
      ...
      ?></td>
      <td><?php if($home->home_ins != '[]') {
        if($homeIns[$m] == 'yes') {
          echo $this->lang->line('NAI');
        }

        if($homeIns[$m] == 'no') {
          echo $this->lang->line('OXI');
        }
  ...
  <div class="modal fade" id="dd63" tabindex="-1" role="dialog" aria-labelledby="dd62" aria-hidden="true">
    <div class="modal-dialog modal1" role="document">
    <div class="modal-content" style="width: 1100px;margin-left: -110px;">
      <div class="modal-header modal-head1">
      <h5 class="modal-title" id="d5"><?php echo $this->lang->line('dash_home_ins');?> </h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
  ...
  <thead class="cf">
    <tr>
      ...
      <th class="th-sm"><?php echo $this->lang->line('EMAIL');?></th>
      <!-- <th class="th-sm"><?php echo $this->lang->line('insurance');?></th> -->
      <th class="th-sm"><?php echo $this->lang->line('insurance_com');?></th>
      <th class="th-sm"><?php echo $this->lang->line('date_renew');?></th>
  ...
  foreach($home_ins as $home) { 
      $h1val = json_decode($home->ins_company);
            $totalVal = count($h1val);
            $homeInscom = json_decode($home->ins_company);
            $homeInscomCount = count($homeIns);
            $homeInsrenew = json_decode($home->date_renew_home1);
           // if($totalVal > 0) {
$cus = $this->user_model->get_cus_name($home->cus_id);
for($m=0;$m<$totalVal;$m++) {
    ?>
    <tr>
      <td data-title="ID"><?php echo $kk;?></td>
      <td data-title="Name"><a href="<?php echo base_url();?>clientDetails/<?php echo $home->cus_id?>" style="color: #0b2b50;"><?php echo $cus->customername;?></a></td>
      ...
      <td data-title="City"><?php  echo $h1val[$m];


      ?></td>

       <!-- <td data-title="City"><?php 
    if($home->home_ins != '[]' && $homeIns[$m] == 'yes') {
      echo $homeInscom[$m];
    }
...
$old = $homeInsrenew[$m];
$new = explode('/',$old);
$date_new = '2019-'.trim($new[1]).'-'.trim($new[0]);
$mydate = strtotime($date_new);
      ?>

       <td data-title="City" data-sort=<?php echo $date_new;?>><?php 
if($home->date_renew_home1 != '[]') {
      echo $homeInsrenew[$m];
  ...
  foreach($car1 as $home) { 
     $h1val = json_decode($home->vehicle);
            $totalVal = count($h1val);
            $car = json_decode($home->car1);
             $car_ins = json_decode($home->car_ins);
             $car_ins_count =  count($car_ins);
...
for($m=0;$m<$totalVal;$m++) {
    ...
    <tr>
      ...
      <td data-title="Name"><a href="<?php echo base_url();?>clientDetails/<?php echo $home->cus_id?>" style="color: #0b2b50;"><?php echo $cus->customername;?></a></td>
      <td data-title="Surname"><a href="<?php echo base_url();?>clientDetails/<?php echo $home->cus_id?>" style="color: #0b2b50;"><?php echo $cus->customerlastname;?></td>
         <td data-title="ID"><a href="mailto:<?php echo $cus->customeremail;?>"><?php echo $cus->customeremail;?></a></td>
  ...
  <div class="modal fade" id="dd65" tabindex="-1" role="dialog" aria-labelledby="dd64" aria-hidden="true">
    <div class="modal-dialog modal1" role="document">
    <div class="modal-content" style="width: 1100px;margin-left: -134px;">
      <div class="modal-header modal-head1">
      <h5 class="modal-title" id="d5"><?php echo $this->lang->line('dash_veh_ins');?> <?php //echo $this->lang->line('insurance');?></h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
  ...
  <tbody>
   <?php if(!empty($car_ins_d)){ 
   // print_r($car_ins_d);
    $k =1;
  foreach($car_ins_d as $home) { 
     $h1val = json_decode($home->ins_company_car);
            $totalVal = count($h1val);
            $car_ins_com = json_decode($home->ins_company_car);
             $car_ins_renew = json_decode($home->date_renew);
            if($totalVal > 0) {
$cus = $this->user_model->get_cus_name($home->cus_id);
for($m=0;$m<$totalVal;$m++) {
    ?>
...
$mydate = strtotime($date_new);
      ?>
       ...
       <td data-title="City" data-sort=<?php echo $date_new;?>><?php 
if($home->car_ins_renew != '[]') {
       echo $car_ins_renew[$m];
     }
  ...
  foreach($small_busines as $home) { 
    $h1val = json_decode($home->small_busines);
            $totalVal = count($h1val);
            $bus_ins = json_decode($home->bus_ins);
...
for($m=0;$m<$totalVal;$m++) {
  ...
  <div class="modal fade" id="dd67" tabindex="-1" role="dialog" aria-labelledby="dd64" aria-hidden="true">
    ...
    <div class="modal-content" style="width: 1100px;margin-left: -134px;">
      <div class="modal-header modal-head1">
      <h5 class="modal-title" id="d5"><?php echo $this->lang->line('dash_bus_ins');?> <?php //echo $this->lang->line('insurance');?></h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
...
$kk=1;
  ...
  foreach($bus_ins_d as $home) { 
     $h1val = json_decode($home->ins_com_bus);
            $totalVal = count($h1val);
             $bus_ins_com = json_decode($home->ins_com_bus);
            $bus_ins_renew = json_decode($home->date_renew_bus);
...
$mydate = strtotime($date_new);
  ...
  foreach($boat as $home) { 
     $h1val = json_decode($home->boat);
            $totalVal = count($h1val);
            $boat_ins = json_decode($home->boat_ins);
...
<?php if($home->boat_ins != '[]') {
  ...
  <div class="modal fade" id="dd69" tabindex="-1" role="dialog" aria-labelledby="dd64" aria-hidden="true">
    ...
    <div class="modal-content" style="width: 1100px;margin-left: -134px;">
      <div class="modal-header modal-head1">
      <h5 class="modal-title" id="d5"><?php echo $this->lang->line('dash_boat_ins');?> <?php //echo $this->lang->line('insurance');?></h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
  ...
  <tbody>
   <?php if(!empty($boat_ins_d)){ 
  //  print_r($customer);
    $k =1;
  foreach($boat_ins_d as $home) { 
     $h1val = json_decode($home->boat_ins);
            $totalVal = count($h1val);
     $ins_com_boat = json_decode($home->ins_com_boat);
     $date_renew_boat = json_decode($home->date_renew_boat);
$cus = $this->user_model->get_cus_name($home->cus_id);
for($m=0;$m<$totalVal;$m++) {
    ?>
    <tr>
     ...
     echo $ins_com_boat[$m];
      ...
      <?php 
$old = $date_renew_boat[$m];
$new = explode('/',$old);
$date_new = '2019-'.$new[1].'-'.$new[0];
$mydate = strtotime($date_new);
      ?>

       <td data-title="City" data-sort=<?php echo $date_new;?>><?php 

       echo $date_renew_boat[$m];
  ...
  <div class="modal fade" id="dd70" tabindex="-1" role="dialog" aria-labelledby="dd64" aria-hidden="true">
    ...
    <div class="modal-content" style="width: 1100px;margin-left: -134px;">
      <div class="modal-header modal-head1">
      <h5 class="modal-title" id="d5"><?php echo $this->lang->line('group_ins');?> </h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
...
$cus = $this->user_model->get_cus_name($home->cus_id);
    ...
    <tr>
      ...
      <td data-title="Surname"><a href="<?php echo base_url();?>clientDetails/<?php echo $home->cus_id?>" style="color: #0b2b50;"><?php echo $cus->customerlastname;?></td></td>
      <td data-title="ID"><a href="mailto:<?php echo $cus->customeremail;?>"><?php echo $cus->customeremail;?></a></td>
      <td data-title="City"><?php echo $home->ins_com_grp;?> </td>
       <?php 
$old = $home->date_renew_grp;
$new = explode('/',$old);
$date_new = '2019-'.$new[1].'-'.$new[0];
$mydate = strtotime($date_new);
      ?>
  ...
  foreach($life_ins1 as $home) { 
    $h1val = json_decode($home->ins_com_life1);
    $totalVal = count($h1val);
    $ins_com_life = json_decode($home->ins_com_life1);
    $date_renew_life = json_decode($home->date_renew_life1);
$cus = $this->user_model->get_cus_name($home->cus_id);
for($m=0;$m<$totalVal;$m++) {
    ?>
    <tr>
...
$mydate = strtotime($date_new);
  ...
  $h1val = json_decode($home->ins_com_oth);
    $totalVal = count($h1val);
    $ins_com_oth = json_decode($home->ins_com_oth);
    $date_renew_oth = json_decode($home->date_renew_oth);
$cus = $this->user_model->get_cus_name($home->cus_id);
for($m=0;$m<$totalVal;$m++) {
...
$mydate = strtotime($date_new);
   ...
   <!-- Modal ends-->
    ...
    series: [{
        ...
        {
            name: 'Widow/er',
            y: <?php echo count($ok_f_no); ?>
        },
        {
            name: 'Widow/er with children',
            y: <?php echo count($ok_g_no); ?>
        }]
    }]
});
    </script>

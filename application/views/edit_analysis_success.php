...
<?php if(isset($_GET['successid']) && !empty($_GET['successid'])){
 ...
 <div class="alert alert-warning" style="margin-bottom: 10rem;">
  ...
  <strong><?php echo $this->lang->line('IRMAEDITSUCCESS')."<strong><br/><br/>" 

  .$this->lang->line('IRMAEDITSUCCESS2')."

  <a href=clientDetails/".$id." >".$this->lang->line('IRMAEDITSUCCESS3')."</a></strong>" ;?>

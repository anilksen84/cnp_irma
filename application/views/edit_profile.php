...
<div class="clearfix"></div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="email" class="form-control input2" name="email" id="email" value="<?php echo $email; ?>" disabled="disabled">
    ...
    <div class="form-group col-md-4">
      ...
      <label for="adt" class="label1"><?php echo $this->lang->line('ARITHMOSTAUTOTITAS'); ?></label>
  ...
  <div class="form-group col-md-4">
      ...
      <label for="pistopoihsh" class="label1"><?php //echo $this->lang->line('PROFILE5'); ?> Show IFAN</label>

      <select id="inputState" class="form-control  input2" name="ifan_status">

       <option value="o" <?php if($profile->ifan_status == 0){ echo 'selected';};?> >Yes</option>

      <option value="1" <?php if($profile->ifan_status == 1){ echo 'selected';};?>>No</option>

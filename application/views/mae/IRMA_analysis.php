...
$maeke = isset($_SESSION['maeke'])?$_SESSION['maeke']:'';
$maekda = isset($_SESSION['maekda'])?$_SESSION['maekda']:'';

$mae_social_benefit = isset($_SESSION['mae_social_benefit'])?$_SESSION['mae_social_benefit']:'';

$mae_quantification_1 = isset($_SESSION['mae_quantification_1'])?$_SESSION['mae_quantification_1']:'';

$mae_quantification_2 = isset($_SESSION['mae_quantification_2'])?$_SESSION['mae_quantification_2']:'';

$mae_existing_policy = isset($_SESSION['mae_existing_policy'])?$_SESSION['mae_existing_policy']:'';
...
?>
   ...
   <div class="col-md-6">
    ...
    <object wmode="transparent" width="450px" height="300px" data="<?php echo base_url();?>assets/new_gif_1/oliki.gif" style="margin-left:113px"></object> 
<?php } else {?>
...
<a href="<?php echo base_url();?>calculators/<?php echo $last;?>" class="btn btn-4" target="__blank"><?php echo $this->lang->line('LIFECALCULATOR');?></a>
 ...
 <div class="row">
    ...
    <label for="socialSecurityBenefit" class="label1"><?php echo $this->lang->line('SSBENEFIT');?></label>
      <input type="text" class="form-control input2" id="mae_social_benefit" name="mae_social_benefit" value="<?php echo $mae_social_benefit;?>">
    </div>
    <div class="col-sm-4">
     <label for="socialSecurityBenefit" class="label1"><?php echo $this->lang->line('replacrate');?> %</label>
      <input type="text" class="form-control input2" id="replace_rate" name="replace_rate_mae" value="<?php echo $replace_rate;?>">
    </div>
     <div class="col-sm-4">
      <label for="socialSecurityBenefit" class="label1"><?php echo $this->lang->line('incomegap');?></label>
      <input type="text" class="form-control input2" id="income_gap" name="income_gap_mae" value="<?php echo number_format($gap_val_p);?>">
    </div>
  </div><br/>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control input2" id="mae_quantification_1" name="mae_quantification_1" value="<?php echo $mae_quantification_1;?>">
    ...
    <div class="form-group">
      ...
      <select id="inputState7" class="form-control  input2" name="mae-ke">
    ...
    <div class="form-group">
      ...
      <select id="inputState8" class="form-control  input2"  name="mae-kda">
    ...
    <div class="form-group">
      ...
      <select id="inputState9" class="form-control  input2" name="mae_existing_policy" id="mae_existing_policy">

        <option value="">Select</option>

       <option value="1" <?php if($mae_existing_policy == '1'){ echo 'selected';}?>>Yes</option>

        <option value="0" <?php if($mae_existing_policy == '0'){ echo 'selected';}?>>No</option>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control input2" id="mae_quantification_2" name="mae_quantification_2" value="<?php echo $mae_quantification_2;?>">
       ...
       var current_sal_mon = $("#current_sal_mon").val();
               if(income != '') {
                 ...
                 // val3 = msg
                  ...
                  $("#mae_social_benefit").val(income);

                  $("#mae_quantification_1").val(val2);
                  $("#income_gap").val(val1);
